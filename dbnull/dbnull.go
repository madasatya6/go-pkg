...
type Example struct {
	...
	PubDate NullTimeMysql 	`json:"pub_date"`
...
type NullTimeMysql mysql.NullTime

// Scan implements the Scanner interface for NullTime
func (nt *NullTimeMysql) Scan(value interface{}) error {
	...
	// if nil then make Valid false
	if reflect.TypeOf(value) == nil {
		*nt = NullTimeMysql{t.Time, false}
	} else {
		*nt = NullTimeMysql{t.Time, true}
	}
...
func (nt *NullTimeMysql) MarshalJSON() ([]byte, error) {
	if !nt.Valid {
		return []byte("null"), nil
	}
...
func (nt *NullTimeMysql) UnmarshalJSON(b []byte) error {
	s := string(b)
	// s = Stripchars(s, "\"")
